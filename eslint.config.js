...
const PUBLIC_GLOBALS = {
  ...
  ViewReports: 'writable', ViewAdmin: 'writable', ViewCrm: 'writable', ViewSupport: 'writable',
...
module.exports = [
  ...
  {
    files: ['eslint.config.js', 'playwright.config.js', 'playwright.cross-browser.config.js', 'scripts/**/*.js'],
